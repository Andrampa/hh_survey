...
table = r'C:\temp\GeoPoll FAO Nigeria COVID 19 HH Pilot Data_20210517_numeric.csv' #include the word 'kobo' or 'geopoll' inside the filename

output_folder = r'C:/temp'
output_file = os.path.join(output_folder,'renamed_table.csv')

df = pd.read_csv(open(table, 'rb'))

dict = {"cs_begging":"cs_emergency_begged","cs_borrowmoney":"cs_stress_borrowed_money",
       "cs_eatplantingseeds":"",
       "cs_eatplantingseeds":"cs_crisis_consumed_seed_stocks","cs_purchasedfoodcredit":"cs_stress_credit",
